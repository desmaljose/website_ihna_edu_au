 ...
 */
    ...
    Router::connect('/quick_enquiry_form/*', array('controller' => 'pages', 'action' => 'quick_enquiry_form'));
	...
	///
	 ...
	 Router::connect('/corporate_testimonials', array('controller' => 'pages', 'action' => 'corporate_testimonials'));
	 Router::connect('/reentry_student_testimonials', array('controller' => 'pages', 'action' => 'reentry_student_testimonials'));
...
// MANUAL HANDLING
 ...
 //Medication Administration for Enrolled Nurses
  ...
  // Router::connect('/apply_online/*', array('controller' => 'pages', 'action' => 'apply_online'));
   
   Router::connect('/courses/Certificate-IV-in-Home-and-Community-Care/*', array('controller' => 'courses', 'action' => 'details', array(19,1)));
   Router::connect('/courses/Certificate-IV-in-Aged-Care/*', array('controller' => 'courses', 'action' => 'details', array(18,1)));  
