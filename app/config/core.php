 ...
 */
	Configure::write('Security.salt', 'IHNA@2015G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '6575696749683645');
 ...
 */
	...
	// LOCAL
        @define('WEB_URL',FULL_BASE_URL.'/website_ihna_edu_au/');
	@define('BASE_URL',FULL_BASE_URL.'/website_ihna_edu_au/');

	@define('SH_URL',FULL_BASE_URL.'/studentportal/');
        
        // SERVER
        //@define('WEB_URL',FULL_BASE_URL.'/');
	//@define('BASE_URL',FULL_BASE_URL.'/');
