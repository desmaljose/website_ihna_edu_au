...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <link href="<?php echo WEB_URL;?>ihna-css/reset.css" rel="stylesheet">
         ...
         <!-- popup CSS -->		
        <link href="<?php echo WEB_URL;?>ihna-css/ekko-lightbox.css" rel="stylesheet">	
        
        <!-- campus page css -->	
        <link rel="stylesheet" type="text/css" href="<?php echo WEB_URL;?>ihna-css/styles-slied.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo WEB_URL;?>ihna-css/demo.css" media="all" />  
    ...
    <style> p{ margin-top:15px !important;}</style>                     
    </head>
