...
<form action="<?php echo WEB_URL; ?>payments/paymentonline_do" method="post" name="onlinepayment" id="onlinepayment">
  ...
  <input type="hidden" name="vpc_ReturnURL" value="<?php echo WEB_URL; ?>payments/payonline_success/" />
