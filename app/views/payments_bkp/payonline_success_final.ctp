...
<div class="container_wrap">
  ...
  <div class="feedback_out_bor" style="height:auto">
    ...
    <p>Invoice Number:  <?php echo $invNum;?></p>
    <p>Candidate Number:  <?php echo $candNum;?></p>
