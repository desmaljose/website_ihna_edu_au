...
<div class="row"> 
 ...
 <br />
        ...
        <div style="background-color:#EEE; border:1px solid #ccc; padding:10px; margin: 10px 0;">
        For payments through international bank transfer, <a href="http://www.geoforeducation.com/IHNA">click here</a>.
        </div>       
               
        <p><b>Please make sure that you enter valid Student ID, Invoice Number and the exact Amount to be transferred</b></p>
        <br />

        <form action="<?php echo WEB_URL; ?>payments/confirm" method="post" name="onlinepayment" id="onlinepayment" onsubmit="return fsubmit();" class="form-horizontal">
            
            
              <div class="form-group">
    <label for="course_name" class="col-sm-3 control-label">Student Name</label>
    <div class="col-sm-9">
        <input name="cname" type="text" class="col-lg-5 col-md-5" id="cname" value="<?php echo @$cname; ?>" size="45"  maxlength="80"/>
    </div>
  </div>
    ...
    <div class="col-sm-9">
        <input name="cnumber" type="text" class="col-lg-5 col-md-5" id="cnumber" value="<?php echo @$cnumber; ?>" size="45"  maxlength="80"/>
    </div>
  </div>
    ...
    <div class="col-sm-9">
        <input name="inumber" type="text" class="col-lg-5 col-md-5" id="inumber" value="<?php echo @$inumber; ?>" size="45"  maxlength="80"/>
    </div>
  </div>
    ...
    <div class="col-sm-9">
        <input name="emailid" type="text" class="col-lg-5 col-md-5" id="emailid" value="<?php echo @$emailid; ?>" size="45"  maxlength="80"/>
    </div>
  </div>
    ...
    <div class="col-sm-9">
        <input name="amount" type="text" class="col-lg-5 col-md-5" id="amount" value="<?php echo @$amount; ?>" size="45"  maxlength="80" onkeyup="calculatefees(this)"/> <span style="margin-left: 10px;">[ eg: X.XX ]</span>
  <input type="hidden" name="txtTax" value="1.5" />  <!--Creditcard fees is 1.5%-->
    ...
    <div class="col-sm-3">
        ...
        <div class="radio">
            ...
            <label><input type="radio" name="rdCardType" value="debit" onclick="calculatefees(this)" checked >Debit Card</label>
        </div>   
    </div>
    <div class="col-sm-6" style="padding-top: 5px;">
        <span style="font-size: 13px;">[ An additional 1.5% of the amount will be charged from Creditcard users. ] </span>
    </div>
    <div class="col-sm-9 col-lg-push-3" style="padding-top: 10px;">
        For payments through international bank transfer, <a href="http://www.geoforeducation.com/IHNA">click here</a>.
    </div>
  </div>
 ...
 <div class="form-group">
     <label for="course_name" class="col-sm-3 control-label">Total amount <br />( Amount + Surcharge )</label>
    <div class="col-sm-9">
 <input name="txtFinalAmount" type="text" class="col-lg-5 col-md-5" id="txtFinalAmount" value="" size="45"  maxlength="20" readonly="readonly"/>  
    </div>
  </div>
...
function calculatefees(ob)
{
	...
	{
            //document.onlinepayment.amount.value = 0;
            document.onlinepayment.txtFinalAmount.value=0;
	}
	else
	{
