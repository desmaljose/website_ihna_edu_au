<div class="forumCategories index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $forumCategory['ForumCategory']['status']; ?>&nbsp;</td>
		<td><?php echo $forumCategory['ForumCategory']['created']; ?>&nbsp;</td>
		<td><?php echo $forumCategory['ForumCategory']['modified']; ?>&nbsp;</td>
		<td class="actions">
