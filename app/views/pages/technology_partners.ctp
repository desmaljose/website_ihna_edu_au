...
<div class="container">
    ...
    <p>At IHNA, we have built our business based on interrelated partnerships with industry leaders in various facilities. IHNA carefully selects its Technology Partners for their best-in-class solutions related to its end-to-end activities and business processes. </p>
    <p>We have joined forces with partner companies in fields related to marketing, business administration, accounting, compliance management as well as the design and delivery of healthcare courses. All of our partners are leaders in their industry, and our collaborations enable us to meet the growing demands of today’s increasingly complex business environment. </p>
    <div class="clear"></div>
    </div>
    
    <div class="teq-partner-box">
    <div class="partner">
    <a href="http://knowledgehub.com.au/" target="_blank"><img src="<?php echo WEB_URL; ?>ihna-images/technology_partners/knowledge-hub.png"/></a>
    </div>
   <!-- <h2>About Knowledge Hub:</h2>-->
    ...
    <div class="teq-partner-box">
    <div class="partner">
    <a href="http://aws.amazon.com/" target="_blank"><img src="<?php echo WEB_URL; ?>ihna-images/technology_partners/amazon.png"/></a>
    </div>
   ...
   <!-- <h2>About Amazon Web Services:</h2> -->
    ...
    <div class="teq-partner-box">
    <div class="partner">
    <a href="http://www.springshare.com/" target="_blank"><img src="<?php echo WEB_URL; ?>ihna-images/technology_partners/spring-share.png"/></a>
    </div>
   ...
   <!-- <h2>About Springshare:</h2> -->
    ...
    <div class="teq-partner-box">
    <div class="partner">
    <a href="https://www.articulate.com/" target="_blank"><img src="<?php echo WEB_URL; ?>ihna-images/technology_partners/articulate.png"/></a>
    </div>
