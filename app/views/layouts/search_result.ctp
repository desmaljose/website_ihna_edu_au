...
<div id="mini-banner">
        ...
        <div class="container"><h1>SEARCH COURSES</h1></div>
        </div>
    </div>   
<!--END BANNER-->                            
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">        		
                        ...
                        <div class="panel-group" id="accordion1">
                            ...
                            <?php
                                ...
                                //echo '<pre>';
                                //print_r($links);
                            foreach($linksInternational as $key => $val){
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div id="collapse<?php echo 'lnk'.$cnt;  ?>" class="panel-collapse collapse" >
                                    <div class="panel-body">
...
<!--                                            <a href="<?php echo WEB_URL; ?>courses/details/<?php echo $row['course_id']; ?>" title="<?php echo $row['course_name']; ?>">-->
                                                ...
                                                <a href="<?php echo $this->Common->courseURL($row['course_id'], 1)?>" title="<?php echo $row['course_name']; ?>">
